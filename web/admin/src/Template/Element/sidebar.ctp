			...
			<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
				<div class="menu_section">
					...
					<ul class="nav side-menu">
						...
						<li>
							<a href="<?php echo DOMAINAD ?><?php echo "administrators";?>"><i class="fa fa-users"></i> Quản lý khách hàng </a>
						</li>
						<li>
				...
				<div class="menu_section">
					...
					<ul class="nav side-menu">
						...
						<li><a class="submenuheader"><i class="fa fa-user"></i> Quản lý Admin Users <span class="fa fa-chevron-down"></span></a>
							<ul class="nav child_menu submenu">
