...
<link rel="stylesheet" href="<?php echo DOMAINAD ?>css/jquery-ui.css">
<script src="<?php echo DOMAINAD ?>js/jquery-ui.js"></script>


<?php
foreach ($name_products as $row) {
    $mang[] = $row->name;
} 
            ...
            <tbody>
                <?php foreach ($products as $product): ?>
                    <tr>
                        ...
                        <td><?= $this->Html->link( $product->name, ['action' => 'edit', $product->id]) ?></td>
