        ...
        <div class="col-sm-3 load-more">
            ...
            <a href="<?php echo DOMAIN ?><?php echo $product['id'] ?>/<?php echo $product['alias'] ?>">
                ...
                <div class="view view view-first">
                    <img src="<?php echo DOMAIN ?><?php echo $product['images'] ?>" class="img-thumbnail center-block" alt="product1" width="304" height="236">
                    <div class="mask">
    ...
    <?php foreach ($products_hot as $product_hot): ?>
        <div class="col-sm-3 load-more1">
            <a href="<?php echo DOMAIN ?><?php echo $product_hot['id'] ?>/<?php echo $product_hot['alias']; ?>">
                ...
                <?php endif ?>
                <div class="view view view-first">
                    <img src="<?php echo DOMAIN ?><?php echo $product_hot['images'] ?>" class="img-thumbnail center-block" alt="product1" width="304" height="236">
                    <div class="mask">
